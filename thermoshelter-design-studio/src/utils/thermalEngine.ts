/**
 * ============================================================================
 * LEGACY CLIENT-SIDE PROTOTYPE (NON-AUTHORITATIVE / DEMO FALLBACK ONLY)
 * ============================================================================
 * IMPORTANT ARCHITECTURAL NOTE:
 * This TypeScript implementation is a legacy client-side prototype. It is NOT
 * the authoritative simulation engine for ThermoShelter AI.
 *
 * ALL AUTHORITATIVE PHYSICAL CALCULATIONS (1D Forward Euler transient heat
 * balance, ISO 6946 multi-layer conduction, Optuna Bayesian optimization)
 * are performed exclusively in Python via FastAPI:
 *   POST /api/simulation/run
 *
 * The official typed API client is in: `src/services/api.ts`.
 * Do NOT use this file for certified scientific results.
 * ============================================================================
 */
